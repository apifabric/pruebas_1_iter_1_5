...
class Employee(Base):
    ...
    salary = Column(Float, nullable=False)  # New salary attribute added
...
# Employees
employee1 = Employee(name='Alice Johnson', position='Manager', salary=50000.00)
employee2 = Employee(name='Bob Williams', position='Cashier', salary=30000.00)
