...
resourcename="pruebas1iter15"  # lower case, only
resourcegroup="pruebas1iter15_rg"
...
# git clone https://github.com/apilogicserver/pruebas1iter15.git
# cd pruebas1iter15
...
az group create --name pruebas1iter15_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group pruebas1iter15_rg --sku S1 --is-linux
az container create --resource-group pruebas1iter15_rg --name pruebas1iter15 --image apilogicserver/pruebas1iter15:latest --dns-name-label pruebas1iter15 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//pruebas1iter15.westus.azurecontainer.io:5656'
